...
logger_manager = logging.getLogger(__name__)

class _ConfigDirManager:
    def get_config_dir(self):
        path = os.path.join(os.path.expanduser("~"), ".arkham-card-maker")
    ...
    def get_language_config_file_path(self):
        return os.path.join(self.get_config_dir(), "language_config.json")

config_dir_manager = _ConfigDirManager()
