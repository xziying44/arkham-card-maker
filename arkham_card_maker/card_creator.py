...
class CardCreator:
    ...
    def create_card(self, card_json: dict, picture_path: Union[str, Image.Image, None] = None, layout_only: bool = False) -> Card:
        """
        入口函数 - 根据卡牌类型创建对应的卡牌
        ...
        _old_layout_only = getattr(self.font_manager, "layout_only", False)
        self.font_manager.layout_only = layout_only
        ...
        try:
            ...
            self.font_manager.layout_only = _old_layout_only
